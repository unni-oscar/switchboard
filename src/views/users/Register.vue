        ...
        <b-card>
          ...
          <b-form @submit.prevent="handleSubmit">
            ...
            <b-form-group
              ...
              :label-cols="4"
             >
              <b-form-input name="name" type="text" v-validate="'required'" placeholder="" v-model="formData.name"></b-form-input>
               <b-form-invalid-feedback :state="false" v-show="errors.has('name')">
                      {{ errors.first('name') }} 
            ...
            <b-form-group
              ...
              :label-cols="4"
              >
               <b-form-input name="address" type="text" v-validate="'required|digits:3'" placeholder="" v-model="formData.address"></b-form-input>
               <b-form-invalid-feedback :state="false" v-show="errors.has('address')">
